...
import { AggregateID, InfrastructureMapper, SystemCode } from "@shared";
...
export class UnitRepositoryImpl extends EntityBaseRepository<Unit, UnitPersistenceDto> implements UnitRepository {
    ...
    constructor(
        ...
        mapper: InfrastructureMapper<Unit, UnitPersistenceDto>
    ) {
        ...
        try {
            ...
            return new Promise((resolve, reject) => {
                ...
                request.onsuccess = (event) => {
                    ...
                    const entities = results.map((item: UnitPersistenceDto) => 
